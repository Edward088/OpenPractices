...
public class ThreadManager {
    ...
    private static class ExecutorHolder {
         ...
         *
         */
        private static ExecutorService mExecutor = new SPCExecutorService();
    }

    public static class SPCExecutorService extends ThreadPoolExecutor {
        ...
        private ThreadFactory mThreadFactory = new ThreadFactory() {
            ...
            public Thread newThread(@NonNull Runnable r) {
                ...
                thread.setName("SPC-Thread-" + threadNumber.getAndAdd(1));
                return thread;
            }
        };

        public SPCExecutorService() {
            super(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE , KEEP_ALIVE, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(128));
        ...
        public void execute(Runnable command) {
            ...
            Log.d(TAG, "Add to Executor: " + command.getClass().toString());
        }

        @Override
        protected void beforeExecute(Thread t, Runnable r) {
            Log.d(TAG, "beforeExecute: " + r.getClass().toString());
        ...
        protected void afterExecute(Runnable r, Throwable t) {
            ...
            Log.d(TAG, "afterExecute: " + r.getClass().toString());
        }
    }
